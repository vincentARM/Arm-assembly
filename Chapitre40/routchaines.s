...
/**********************************************/
.text            
/* declaration externe des routines */
.global copiechaine,concatchaineTas,comparchaine,tritablechaine,comparchaineScasse
.global eclatechaine,longueurchaine
...
copiecarchaine:
   push {fp,lr}    /* save des  2 registres frame et retour */
   push {r2,r4}   /* save autres registres en nombre pair */
   	mov r4,#0
    /* boucle de copie des caractères */
1:	                  /* label local */
	ldrb r3,[r0,r4]
